...
return [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
            /*
             * Retention policy:
             * - Last 360 days: Keep all daily backups
             * - Next 360 days (720 days total): Keep weekly backups only
             * - Next 18 months (3 years total): Keep monthly backups only
             * - Older than 3 years: Delete
             */
            'keep_all_backups_for_days' => 360, // ~1 year - keep everything

            'keep_daily_backups_for_days' => 720, // 2 years total - keep daily

            'keep_weekly_backups_for_weeks' => 104, // ~2 years - keep weekly (720 days / 7)

            'keep_monthly_backups_for_months' => 36, // 3 years total - keep monthly
            ...
            /*
             * Never delete based on size - keep all backups
